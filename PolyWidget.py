...
from Lab7 import import_iris, polynomial_kernel, class_to_int
...
clf = polynomial_kernel(X_train, X_test, y_train, y_test)
...
plot(clf, "Decision Surface for Polynomial Kernel", X, y)
