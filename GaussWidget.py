...
from Lab7 import import_iris, gaussian_kernel, class_to_int
...
clf = gaussian_kernel(X_train, X_test, y_train, y_test)
...
plot(clf, "Decision Surface for Gaussian Kernel", X, y)
